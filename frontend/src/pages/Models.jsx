...
export default function Models() {
  ...
  const MODE_META = { chat: { color: 'blue', label: '对话' }, embedding: { color: 'purple', label: '向量' }, image: { color: 'magenta', label: '图像' }, rerank: { color: 'cyan', label: '重排' }, audio: { color: 'gold', label: '音频' } }
  const columns = [
    {
    ...
    },
    {
      ...
      filters: [{ text: '对话', value: 'chat' }, { text: '向量', value: 'embedding' }, { text: '图像', value: 'image' }, { text: '重排', value: 'rerank' }, { text: '音频', value: 'audio' }],
